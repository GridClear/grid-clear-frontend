...
export function FooterCta() {
  return (
    <section className="bg-black py-24 md:py-32 border-b border-white/5">
      <div className="mx-auto flex max-w-content border-l border-r border-white/10 flex-col items-start gap-8 px-6 md:flex-row md:items-center md:justify-between md:px-10">
        <Link
          href={footerCta.primary.href}
          className="text-3xl font-extrabold text-white tracking-[-0.035em] hover:text-gc-accent transition-colors duration-200 md:text-5xl font-heading"
        >
